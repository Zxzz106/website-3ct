          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl w-full mx-auto">
            {members.teacher.map((member) => (
              <Link
                ...
                className="group"
              >
                <div className="bg-white dark:bg-gray-800/40 backdrop-blur-sm rounded-3xl border border-gray-100 dark:border-gray-700/50 shadow-sm p-8  transition-all duration-500 h-full flex flex-col items-center">
